...
b1img = loadImage("pictures/b1.png");
b2img = loadImage("pictures/b2.png");
b3img = loadImage("pictures/b3.png");
goimg=loadImage("pictures/10.jpg");
}
...
if(gamestate==="play"){
bg.visible=false;
   background(brazilimg);
   
}

if(mousePressedOver(cov2)){
  gamestate="play2";
}
...
function spawnenemy(){
  if(frameCount%50=== 0){
    enemy  = createSprite(random(100,700),random(100,400),20,20);
    enemy.scale = 0.1;
    var ran = Math.round(random(1,3));
      switch (ran){
      case 1: enemy.addImage(b1img);
      break;
      case 2: enemy.addImage(b2img);
      break;
      case 3: enemy.addImage(b3img);
      break;
      default:break;
    }
  enemy.lifetime  = Math.round(random(20,70));
